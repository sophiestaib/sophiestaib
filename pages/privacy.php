...
<head>
    ...
    <title>Privacy | HUERTA</title>
    <link rel="stylesheet" href="../assets/css/style.css">
    <meta name="description" content="Privacy policy for HUERTA">
</head>
<body>
<div id="app">
    <header class="header" role="banner">
        ...
        <div class="container">
            ...
            <p class="lead">This is a sample privacy policy. Replace with your real policy before going live.</p>
            <section>
                <h2>Data Collection</h2>
                <p>We collect only minimal data required to process orders and contact you.</p>
            </section>
            <section>
                <h2>Cookies</h2>
                <p>We use cookies for a better user experience. You can opt-out in your browser settings.</p>
            </section>
        </div>
    </main>
